...
export default class BookChapters extends Component {
  ...
  _renderRow = (chapter: Object, sectionID: string, rowID: string, highlightRow: boolean) => {
    ...
    return (
      <TouchableOpacity style={styles.section} onPress={() => this.props.navigate(readerURL({bookID: book.id, chapterNumber, title: book.name, description: `${book.name} ${chapterNumber}`}))}>
