  ...
  return (
    <View>
      ...
      <View style={StyleSheet.styles.discoveryCenter.bottomContainer}>
        <Text>Is</Text>
        <TouchableOpacity hitSlop={{top: 10, left: 5, bottom: 10, right: 0}} style={styles.filterButton} onPress={() => props.onPressEditFilter(actantFilterURL({title: Localizable.t(actantType), filter: props.filter}))}>
...
export default ActantFilterItem;
