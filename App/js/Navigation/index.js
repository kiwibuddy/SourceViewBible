...
import DiscoveryCenterShare from '../Scenes/DiscoveryCenter/Share';
...
export const bookmarkURL = router.addRoute('/Bookmarks/:bookmarkID', Bookmark);
...
export const discoveryCenterShareURL = router.addRoute('/DiscoveryCenter/Share', DiscoveryCenterShare);
