...
export default class Occurrences extends Component {
  ...
  _renderRow = (occurrence: Object, sectionID: any, rowID: any) => {
    ...
    const route = readerURL({bookID: book.id, anchor: `monad-${occurrence.firstMonad}`, title: book.name, description: bsoReference, occurrenceIndex, occurrences, occurrencesRoute});
