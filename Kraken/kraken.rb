...
actant_objects = DB['SELECT DISTINCT actant_objects.*, actant_mdf_real_name_set.string_value AS real_name,
	...
	CASE WHEN recipientactant_objects.object_id_d > 0 THEN 2 ELSE 0 END AS is_recipient
